...
Projeto desenvolvido por José Cunha e Gabriel Pinto. Os resultados representam
uma experiência de inversão de prompts com restrições fixas de modelo e seed,
não um método geral de reconstrução exata de imagens.
